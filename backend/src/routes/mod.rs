...
fn posting_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/proposals/:id/accept", post(handlers::clients::accept_proposal))
}
...
fn payment_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/invoices/:id", get(handlers::payments::get_invoice))
        .route("/invoices/:id/html", get(handlers::payments::get_invoice_html))
